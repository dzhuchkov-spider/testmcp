...
Process:
- Use local design tokens from '@/shared/config/theme' as the primary source of truth.
- Only use Figma MCP when explicitly asked via @Figma for specific UI-screens (use exact Node IDs).
