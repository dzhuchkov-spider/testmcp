...
export const AddressesPage: React.FC<PageProps> = ({ onNavigateToMain }) => {
      ...
      <MainContent>
        ...
        <ContentLayout>
          ...
          <InputsSection>
            {/* Форма с адресами */}
            <FormSection>
              <FormTitle>Мои адреса</FormTitle>
              
              <Typography variant="body1" sx={{ color: '#666' }}>
                Здесь будет список адресов доставки
              </Typography>
            </FormSection>
          </InputsSection>
        </ContentLayout>
